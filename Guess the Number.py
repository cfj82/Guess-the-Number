...
f0 = Frame(root, pady=3, bg="#000000")  # frame for quit and start button
...
f1 = Frame(root, pady=3, bg="#000000")  # frame for quit and start button
...
# entry field
entry = Entry(f2, font=("verdana", 15),
                    bg="#D5D8DC", text="Submit",
              textvariable=guess_num)
entry.pack(side=LEFT, expand=True, fill="both", pady=3, padx=6)

# submit button
submit_btn = Button(f2, font=("verdana", 15), anchor="center",
...
# hint label
hint_lbl = Label(f3, font=("verdana", 18), anchor="center",
                    bg="#5DADE2",
                 textvariable=hint)
